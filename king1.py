...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Devil-S1X4N/test/blob/main/aprv.txt"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Devil-S1X4N/test/blob/main/aprv.txt').text
			if basesplit in plr:
				key = basesplit
